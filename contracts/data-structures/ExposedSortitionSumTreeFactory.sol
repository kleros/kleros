 ...
 *  @notice Exposed version of SortitionSumTreeFactory for testing.
 */
contract ExposedSortitionSumTreeFactory is SortitionSumTreeFactory {
     ...
     */
    function _deleteTree(bytes32 _key) internal {
     ...
     */
    function _append(bytes32 _key, uint _value, address _address) internal returns(uint treeIndex) {
     ...
     *  @param _address The candidate's address.
     */
    function _remove(bytes32 _key, uint _treeIndex, address _address) internal {
     ...
     *  @param _address The candidate's address.
     */
    function _set(bytes32 _key, uint _treeIndex, uint _value, address _address) internal {
     ...
     */
    function _draw(bytes32 _key, uint _drawnNumber) internal view returns(address _address) {
