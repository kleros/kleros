...
//   'kleros-interaction/ArbitrableTransaction.sol'
// )
...
//     let pinakion = await Pinakion.new(
//       0x0,
//       0x0,
//       0,
//       'Pinakion',
...
//     let klerosPOC = await KlerosPOC.new(
//       pinakion.address,
//       rng.address,
//       [2, 4, 8, 2, 5],
//       governor,
...
//     let tx = await klerosPOC.voteRuling(0, 1, [1, 2, 3], {
//       from: jurorA,
//       gasPrice: gasPrice
//     })
...
//     let arbitrableTransactionPostDraw = await ArbitrableTransaction.new(
//       klerosPOC.address,
//       0x0,
//       0,
//       payee,
